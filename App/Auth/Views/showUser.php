            ...
            <form action="" method="get">
              ...
              foreach ($persons as $person) {
                ...
                echo "
											<tr>
												<td>{$n}</td>
                                                <td><img src='{$avatar}' class='avatar' style='width:50px;height:50px;'>
												...
												<td>{$person['dob']}</td>
												<td>{$person['lg_name']}</td>												
												<td>{$person['salary']}</td>
												<td>
													<a href='../../views/auth/editUser.php?id={$person['id']}&action=update' class='mr-2 btn btn-outline-info round'>แก้ไข</a>
													...
													<a href='../../views/auth/setAuth.php?id={$person['id']}' class='btn btn-outline-primary round' >สิทธิ์</a>
												</td>
											</tr>
										";
              }
...
<div class="modal-info mr-1 mb-1 d-inline-block">
  ...
  <div class="modal fade text-left" id="del" tabindex="-1" role="dialog" aria-labelledby="myModalLabel130"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
      <form class="modal-content" action="del_edit_auth.php" id="form-delete-user">
