...
<head>
  ...
  <title>NcwBudget - ระบบแผนงานงบประมาณ</title>
  <!-- Favicon -->
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" href="#navbar-dashboards" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-dashboards">
                ...
                <span class="nav-link-text">ภาพรวมการใช้งเิน</span>
              </a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="#navbar-examples" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
                ...
                <span class="nav-link-text">สรุปการใช้เงิน</span>
              </a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="#navbar-forms" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-forms">
                ...
                <span class="nav-link-text">จัดการเบิกเงินตามแผน</span>
              </a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="#navbar-tables" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
                ...
                <span class="nav-link-text">จัดการสถานะการเบิก</span>
              </a>
          ...
          <h6 class="navbar-heading p-0 text-muted">
            <span class="docs-normal">My Profile</span>
        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6">
            <div class="copyright text-center  text-lg-left  text-muted">
              &copy; 2021 <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">2020 © Ncwbudget</a>
            </div>
          </div>
          <div class="col-lg-6">
            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
              <li class="nav-item">
                <a href="#" class="nav-link" target="_blank">โดยทีมงานคอมพิวเตอร์ by แผนงานงบประมาณ V.1.2</a>
              </li>
            </ul>
          </div>
        </div>
