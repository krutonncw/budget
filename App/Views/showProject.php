            ...
            <form proion="" method="get">
              ...
              foreach ($projects as $project) {
                ...
                if ($project['pro_balance'] >= 5000) {
                  echo "<td ><span class='badge bg-info round'>" . number_format($project['pro_balance'], 2) . "</span></td></tr>";
                } elseif ($project['pro_balance'] >= 2000) {
                  echo "<td ><span class='badge bg-warning round'>" . number_format($project['pro_balance'], 2) . "</span></td></tr>";
                } else {
                  echo "<td ><span class='badge bg-danger round'>" . number_format($project['pro_balance'], 2) . "</span></td></tr>";
                }
              }
              ?>
            </form>
