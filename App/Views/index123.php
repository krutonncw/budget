    ...
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup">
                <form action='../Auth/Controllers/checkLogin.php' class="sign-in-form" method="POST">
                ...
                <form action="../Auth/Controllers/addPerson.php" class="sign-up-form" method="get" name="new">
