          ...
          <tbody>
            <form action="" method="get">
              ...
              foreach ($payplans as $payplan) {
                ...
                echo "<td>" . number_format($payplan['pay_bill'], 2) . "</td>";
                ...
                if ($_SESSION['role'] < 3) {
                  echo "<td><a href='addPayStep.php?pay_order={$payplan['pay_order']}' class='btn btn-outline-info round btn-sm'>แก้ไข " . $payplan['pay_step'] . "</a>";
                }
