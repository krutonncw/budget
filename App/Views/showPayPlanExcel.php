...
if (isset($_GET['act'])) {
  if ($_GET['act'] == 'excel') {
    ...
    header('Content-Disposition: attachment; filename="payplan.xls"'); //กำหนดชื่อไฟล์
  ...
  <div class="page-title">
    <div class="row">
      <div class="col-12 col-md-6 order-md-1 order-last">
        <h3>ข้อมูลการเบิก<span class='badge bg-success round '> รายละเอียด </span> </h3>
      </div>
    </div>
  </div>
  <section class="section">
    <div class="card">
      <div class="card-header">
        ข้อมูลการเบิกตามกิจกรรม <a href="?act=excel" class="btn btn-primary"> Export->Excel </a>
      </div>
      <div class="card-body">
        <table class='table table-striped' id="table1">
          ...
          <tbody>
            <form action="" method="get">
              ...
              $payplans = $payplanObj->getPayPlanToExcel();
              ...
              foreach ($payplans as $payplan) {
                ...
                echo "
                  ...
                  <td>{$payplan['pro_id']}</td>
                  <td>{$payplan['dep_id']}</td>
                ";
