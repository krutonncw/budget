        ...
        <div class="modal-content">
            <form action="../Controllers/addActivity.php" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="add_act_balance" class="form-label">งบประมาณคงเหลือ</label>
                        <input type="number" step="0.01" class="form-control" name="act_balance" id="add_act_balance"
                            required>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <form action="../Controllers/updateActivity.php" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">งบประมาณคงเหลือ</label>
                            <input type="number" step="0.01" class="form-control" name="act_balance"
                                value="<?php echo $activity['act_balance']; ?>" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary round" data-dismiss="modal">ยกเลิก</button>
