...
$mpdf = new \Mpdf\Mpdf([
  ...
  'fontDir' => array_merge($fontDirs, [
    // __DIR__ . '/fonts', // กำหนดโฟลเดอร์ฟอนต์ที่ใช้
    '/fonts',
  ]),
  'fontdata' => $fontData + [
    'sarabun' => [
  ...
  // 'autoLangToFont' => true, // สำคัญสำหรับการเลือกฟอนต์ตามภาษา
  // 'autoScriptToLang' => true, // สำคัญสำหรับการเลือกฟอนต์ตามภาษา
  // 'lang' => 'th', // กำหนดภาษาเป็นไทย
  'debug' => true, // เปิดโหมด debug เพื่อดูข้อมูลการทำงาน (ปิดเมื่อใช้งานจริง)
]);
...
<body>
  <table>
    ...
    <tr>
      <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <?php echo $payplans['pay_objective']; ?> ตามแผนปฏิบัติการประจำปี โครงการ<?php echo $payplans['pro_name']; ?> -
        <?php echo $payplans['act_name']; ?>
        เป็นจำนวนเงิน <?php echo number_format($payplans['pay_money'], 2); ?> บาท (<?php echo $thaibath; ?>)
        <!-- <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        กิจกรรมนี้ได้รับเงินจัดสรรประจำปี จำนวน <?php echo number_format($payplans['act_money'], 2); ?> บาท ใช้ไปแล้ว <?php echo number_format($payplans['act_money'] - $payplans['act_balance'] - $payplans['pay_money'], 2); ?> บาท <br>เบิกครั้งนี้แล้วคงเหลือ <?php echo number_format($payplans['act_balance'], 2); ?> บาท ประเภทเงิน <?php echo $payplans['bgt_name']; ?> -->
      </td>
    </tr>

    <tr>
      <td colspan="2">
        รายละเอียดตามเอกสารที่แนบ <br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;) 1. ประมาณการค่าใช้จ่าย
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;) 2. ขอบเขตของงานหรือรายละเอียดคุณลักษณะเฉพาะ
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;) 3. ปร 4,5,6</td>
    </tr>

    <tr>
      <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        จึงเรียนมาเพื่อโปรดพิจารณาอนุมัติ</td>
    </tr>
    ...
    <tr>
      <td style="width:50%; border-right: 1px solid black;" valign="top">
        <table style="border: 0px; width: 100%;">
          ...
          <tr>
            <td>
              2. ตรวจสอบงาน/โครงการแล้ว ปรากฎว่า<br>
              <!-- &nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;) มีในแผนปฏิบัติการประจำปี <br>
              &nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;) ไม่มีในแผนปฏิบัติการประจำปี <br><br><br> -->
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ได้รับงบประมาณ <?php echo number_format($payplans['act_money'], 2); ?>
              บาท <br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ประเภทเงิน<?php echo "<u>" . $payplans['bgt_name'] . "</u>"; ?> <br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เบิกจ่ายไปแล้ว
              <?php echo number_format($payplans['act_money'] - $payplans['act_balance'] - $payplans['pay_money'], 2); ?>
              บาท <br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เบิกจ่ายครั้งนี้
              <?php echo number_format($payplans['pay_money'], 2); ?> บาท <br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;คงเหลือ <?php echo number_format($payplans['act_balance'], 2); ?> บาท
              <br><br>
            </td>
          </tr>
          <tr>
      ...
      <td style="width:50%; vertical-align: top;">
        <table style="border: 0px; width: 100%">
          <tr>
            <td>
              3. ความเห็นรองผู้อำนวยการฯ กลุ่มบริหารงบประมาณ<br>
              &nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;) เห็นสมควรอนุมัติ <br>
              &nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;) ไม่สมควรอนุมัติ
              เพราะ..........................................<br><br><br>
            </td>
  ...
  <!-- <table>
    <tr>
      <td>
        มีรายละเอียดดังแนบ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;) 1. ประมาณการค่าใช้จ่าย&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;) 2. ขอบเขตของงานหรือรายละเอียดคุณลักษณะเฉพาะ
      </td>
    </tr>
  </table> -->
